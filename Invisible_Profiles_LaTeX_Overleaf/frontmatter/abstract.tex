...
\noindent Using the SHARE Wave~9 release (2021--2022), two country-specific analytical samples are built (2{,}378 Italian and 1{,}787 Swedish respondents aged 65 or older) and each is segmented independently through a pipeline that applies factor-analytic diagnostics to a joint input space of objective resources (health, wealth, social contact, digital adoption) and subjective dimensions of late-life experience (CASP-12 quality of life, loneliness, hope, interest, expected survival), the latter treated as constituent inputs rather than as external validators. K-means partitions the standardised analytical space at $k = 5$ for Italy and $k = 6$ for Sweden; Latent Class Analysis provides cross-method triangulation; centroid-distance matching in the standardised space aligns the two partitions for cross-country comparison.
...
\noindent\textbf{Keywords:} multidimensional segmentation; older adults; SHARE Wave~9; welfare regimes; cross-country comparison; Italy; Sweden; silver economy; subjective well-being; K-means; Latent Class Analysis.
