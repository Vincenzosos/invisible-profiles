...
\looseness=-1 The thesis is organised in nine chapters. Chapter~\ref{ch:ch2} reviews the five strands of literature that anchor the strategy: comparative welfare regimes, gerontological subjective dimensions, segmentation methodology, silver economy and gerontechnology, and European typological studies. Chapter~\ref{ch:ch3} sets out the pipeline: SHARE Wave~9 sample preparation, factor-analytic diagnostics, K-means clustering ($k = 5$ Italy, $k = 6$ Sweden), Latent Class Analysis triangulation, and the empirical justification of the subjective block as input.
