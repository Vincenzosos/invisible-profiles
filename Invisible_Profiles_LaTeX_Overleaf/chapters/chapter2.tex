...
\begin{tabularx}{\textwidth}{@{}>{\bfseries\raggedright\arraybackslash}p{3.1cm} >{\raggedright\arraybackslash}X >{\columncolor{blue!7}\raggedright\arraybackslash}X@{}}
\toprule
\rowcolor{gray!12}
Design dimension & \textbf{Prevailing practice in the literature} & \textbf{This thesis} \\
\midrule
