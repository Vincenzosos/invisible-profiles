...
% Page 4: blank
\thispagestyle{empty}\null\clearpage
% Bocconi §10.3.1: printed numbering starts at 1 on the first content page (TOC)
\setcounter{page}{1}
\fi

% Raise starred-chapter titles (Contents / List of Figures /
% List of Tables / Bibliography). Default report \@makeschapterhead uses
% \vspace*{50pt} above and \vskip 40pt below; compact them uniformly so the
% List of Figures fits on a single page. Title stays airy, never at the edge.
\makeatletter
