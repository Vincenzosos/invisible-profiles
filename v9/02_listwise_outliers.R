...
#
# INPUT:  v9/step1_italy_assembled.rds
# OUTPUT: v9/step2_italy_clean.rds
# ==============================================================================
...
italy <- readRDS(file.path(data_path, "v9", "outputs", "step1_italy_assembled.rds"))
cat("  Loaded step1_italy_assembled.rds:", nrow(italy), "rows x", ncol(italy), "cols\n\n")
...
# Salva entrambi
saveRDS(italy_clean_original, file.path(data_path, "v9", "outputs", "step2_italy_clean.rds"))
saveRDS(italy_clean_std,      file.path(data_path, "v9", "outputs", "step2_italy_std.rds"))

cat("\n  Salvato: v9/step2_italy_clean.rds     (valori originali, per descrittiva)\n")
cat("  Salvato: v9/step2_italy_std.rds       (standardizzati, per clustering)\n")
