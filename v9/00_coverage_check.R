...
data_path <- "/Users/vincenzosilvestri/Desktop/SHARE DATASET/"

# --- 1. Load coverscreen (per country + age) ---
cv <- read_dta(paste0(data_path, "_share_data/sharew9_rel9-0-0_cv_r.dta"))
...
# --- 2. Load Big Five ---
big5 <- read_dta(paste0(data_path, "_share_data/sharew9_rel9-0-0_gv_big5.dta"))
...
ex <- read_dta(paste0(data_path, "_share_data/sharew9_rel9-0-0_ex.dta"))
