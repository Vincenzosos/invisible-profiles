...
#     dal raw SHARE `sharew9_rel9-0-0_ac.dta` via ac012_ per country=13 (Svezia)
#
# INPUT:  v9/step4_sweden_std.rds            (standardizzate, per clustering)
#         v9/step4_sweden_clean.rds          (valori originali, per descrittive)
#         sharew9_rel9-0-0_ac.dta            (ac012_ life satisfaction)
# OUTPUT: v9/step8_sweden_kmeans_k6.rds      (k-means output)
#         v9/step8_sweden_with_clusters.rds  (dati + cluster + labels)
#         v9/step8_sweden_profile_table.rds  (tabella riassuntiva profili)
# ==============================================================================
...
ac_file <- file.path(data_path, "_share_data", "sharew9_rel9-0-0_ac.dta")
...
saveRDS(kmeans_k6_results, file.path(data_path, "v9", "outputs", "step8_sweden_kmeans_k6.rds"))
cat("  Salvato: v9/step8_sweden_kmeans_k6.rds\n")

saveRDS(sweden_clean_enriched, file.path(data_path, "v9", "outputs", "step8_sweden_with_clusters.rds"))
cat("  Salvato: v9/step8_sweden_with_clusters.rds\n")

saveRDS(profile_table, file.path(data_path, "v9", "outputs", "step8_sweden_profile_table.rds"))
cat("  Salvato: v9/step8_sweden_profile_table.rds\n")
