...
#
# INPUT:  v9/step2_italy_w8_std.rds   (standardizzate, per PCA/FA)
#         v9/step2_italy_w8_clean.rds  (valori originali, per descrittiva)
# OUTPUT: v9/step5_italy_w8_pca_results.rds
#         v9/step5_italy_w8_fa_results.rds
# ==============================================================================
...
saveRDS(pca_results, file.path(data_path, "v9", "outputs", "step5_italy_w8_pca_results.rds"))
cat("  Salvato: v9/step5_italy_w8_pca_results.rds\n")
...
saveRDS(fa_results, file.path(data_path, "v9", "outputs", "step5_italy_w8_fa_results.rds"))
cat("  Salvato: v9/step5_italy_w8_fa_results.rds\n")
...
saveRDS(italy_with_scores, file.path(data_path, "v9", "outputs", "step5_italy_w8_with_fa_scores.rds"))
cat("  Salvato: v9/step5_italy_w8_with_fa_scores.rds (dati + factor scores)\n")
...
cat("  (step2_italy_w8_std.rds), NON sui factor scores.\n")
