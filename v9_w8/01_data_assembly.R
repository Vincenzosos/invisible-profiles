...
#
# OUTPUT: step1_italy_w8_assembled.rds
# ==============================================================================
...
if (!file.exists(file.path(data_path, "_share_data", "sharew8_rel9-0-0_gv_imputations.dta"))) {
...
saveRDS(italy, file.path(data_path, "v9", "outputs", "step1_italy_w8_assembled.rds"))
cat("\n  Salvato: v9/step1_italy_w8_assembled.rds\n")

# Anche un CSV per ispezione rapida
write.csv(italy[1:20, c("mergeid", "age", "gender", all_31)],
          file.path(data_path, "v9", "outputs", "step1_w8_preview.csv"),
          row.names = FALSE)
cat("  Salvato: v9/step1_w8_preview.csv (prime 20 righe)\n")
