...
#
# INPUT:  v9/step3_sweden_w8_assembled.rds
# OUTPUT: v9/step4_sweden_w8_clean.rds, v9/step4_sweden_w8_std.rds
# ==============================================================================
...
sweden <- readRDS(file.path(data_path, "v9", "outputs", "step3_sweden_w8_assembled.rds"))
cat("  Loaded step3_sweden_w8_assembled.rds:", nrow(sweden), "rows x", ncol(sweden), "cols\n\n")
...
it_file <- file.path(data_path, "v9", "outputs", "step2_italy_w8_clean.rds")
...
saveRDS(sweden_clean_original, file.path(data_path, "v9", "outputs", "step4_sweden_w8_clean.rds"))
saveRDS(sweden_clean_std,      file.path(data_path, "v9", "outputs", "step4_sweden_w8_std.rds"))

cat("\n  Salvato: v9/step4_sweden_w8_clean.rds     (valori originali)\n")
cat("  Salvato: v9/step4_sweden_w8_std.rds       (standardizzati)\n")
