...
#   - Input: step4_sweden_w8_std.rds (Svezia passa per step3→step4, non step2)
...
#
# INPUT:  v9/step4_sweden_w8_std.rds    (standardizzate, per PCA/FA)
#         v9/step4_sweden_w8_clean.rds  (valori originali, per descrittiva)
# OUTPUT: v9/step6_sweden_w8_pca_results.rds
#         v9/step6_sweden_w8_fa_results.rds
#         v9/step6_sweden_w8_with_fa_scores.rds
# ==============================================================================
...
saveRDS(pca_results, file.path(data_path, "v9", "outputs", "step6_sweden_w8_pca_results.rds"))
cat("  Salvato: v9/step6_sweden_w8_pca_results.rds\n")

if (!exists("fa_course")) fa_course <- NULL
fa_results <- list(
  fa_model        = fa_result,
...
saveRDS(fa_results, file.path(data_path, "v9", "outputs", "step6_sweden_w8_fa_results.rds"))
cat("  Salvato: v9/step6_sweden_w8_fa_results.rds\n")

sweden_with_scores <- cbind(sweden_clean, factor_scores)
saveRDS(sweden_with_scores, file.path(data_path, "v9", "outputs", "step6_sweden_w8_with_fa_scores.rds"))
cat("  Salvato: v9/step6_sweden_w8_with_fa_scores.rds (dati + factor scores)\n")
...
cat("  (step4_sweden_w8_std.rds), NON sui factor scores.\n")
